...
class Affordableupdatescrreen extends StatefulWidget {
  const Affordableupdatescrreen({super.key, required this.docid});
  final String docid;

  @override
  State<Affordableupdatescrreen> createState() =>
      _AffordableupdatescrreenState();
}

class _AffordableupdatescrreenState extends State<Affordableupdatescrreen> {
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const Affoupdatescreen(),
                              )),
                          child: Container(
                            height: 40,
                            width: 300,
