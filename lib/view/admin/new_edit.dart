...
class Newestsingleupdate extends StatefulWidget {
  const Newestsingleupdate({super.key, required this.docid});
  final String docid;

  @override
  State<Newestsingleupdate> createState() => _NewestsingleupdateState();
}

class _NewestsingleupdateState extends State<Newestsingleupdate> {
                                  ...
                                  onPressed: () async {
                                    ...
                                    await reference.ref.getDownloadURL().then(
                                          (value) => FirebaseFirestore.instance
                                              .collection("imageurl3")
                                              .doc(widget.docid)
                                              .update({"url": value,"type": nameconroller.text,
