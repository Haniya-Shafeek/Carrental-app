...
class Upload3screen extends StatefulWidget {
  const Upload3screen({super.key});

  @override
  State<Upload3screen> createState() => _Upload3screenState();
}

class _Upload3screenState extends State<Upload3screen> {
  ...
  void initState() {
    ...
    super.initState();
    imgref3 = FirebaseFirestore.instance.collection("imageurl3");
  }
