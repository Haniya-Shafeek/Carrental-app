import 'package:carrentalapp/view/user/popular_book.dart';
...
class Popularsingleview extends StatefulWidget {
  const Popularsingleview({super.key, required this.docid});
  final String docid;

  @override
  State<Popularsingleview> createState() => _PopularsingleviewState();
}

class _PopularsingleviewState extends State<Popularsingleview> {
  bool isliked = false;
  @override
                              ...
                              onTap: () => Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => Mapscreen(
                                        docid: snapshot.data!.id.toString()),
                                  )),
                              child: const Padding(
