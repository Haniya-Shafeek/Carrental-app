...
class Affobookingscreen extends StatefulWidget {
  const Affobookingscreen({super.key, required this.docid});
  final String docid;

  @override
  State<Affobookingscreen> createState() => _AffobookingscreenState();
}

class _AffobookingscreenState extends State<Affobookingscreen> {
