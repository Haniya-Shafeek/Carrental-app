import 'package:carrentalapp/view/user/new_book.dart';
...
class Newwstsingleview extends StatefulWidget {
  const Newwstsingleview({super.key, required this.docid});
  final String docid;

  @override
  State<Newwstsingleview> createState() => _NewwstsingleviewState();
}

class _NewwstsingleviewState extends State<Newwstsingleview> {
  bool isliked = false;
  @override
